# Formal E5 design freeze — complete E5-A/B/C execution
...
- Correctness precedes runtime interpretation. E5-A is the real Rawls24 baseline;
  E5-B isolates scenario-count scalability at I=3; E5-C isolates commodity-count
  scalability at Omega=100.
...
- E5-C completed under the frozen commodity-scalability design at 540/540 certified timed runs.
- E5-C uses the frozen nested 9-item generator, one shared 100-scenario table per
  replicate, and a size-specific benchmark B_ref with B/B_ref=1.
- Synthetic E5-B/E5-C instances are computational benchmarks, not empirical
  disaster or commodity probability models.
